...
namespace api.Controllers
{
    ...
    public class PrioritiesController : ControllerBase
    {
        ...
        public PrioritiesController(TaskTrackerContext context)
        {
            _context = context;
        }
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<Priority>> GetPriority(sbyte? id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutPriority(sbyte? id, Priority priority)
        {
            if (id != priority.Id)
            {
                return BadRequest();
        ...
        [HttpDelete("{id}")]
        public async Task<IActionResult> DeletePriority(sbyte? id)
        {
            var priority = await _context.Priorities.FindAsync(id);
            if (priority == null)
            {
        ...
        private bool PriorityExists(sbyte? id)
        {
